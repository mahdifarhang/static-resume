export default () => {
  return {
    ...
    about: `As a ${Math.floor((new Date().getTime() - new Date(1998, 1, 27)) / (1000 * 60 * 60 * 24 * 365.25))}-year-old programmer,
      I have done my Bachelor's in computer engineering and have worked in the field as well.
      ...
      I have met many challenges along the way, and I guess the most important thing that I can tell about myself is the ability to solve challenges and tackle problems,
      and my unstoppable passion to take the further step and learn more all the time.`,
